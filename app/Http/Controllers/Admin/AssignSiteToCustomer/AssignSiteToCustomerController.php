...
namespace App\Http\Controllers\Admin\AssignSiteToCustomer;
...
class AssignSiteToCustomerController extends Controller
{
    ...
    public function index(){
        ...
        $assignedDevices=AssignSiteToCustomer::where('status','active')->with('site','customer')->get();
         ...
         return view('Admin.AssignSiteToCustomer.assigned_site_listing');
     ...
     public function add(){
         ...
         if(!empty($RolesPrivileges) && str_contains($RolesPrivileges, 'map_site_add')){
             ...
             return view('Admin.AssignSiteToCustomer.assign_site_to_customer',compact('customers','sites'));
     ...
     public function edit($id){
         try {
             ...
             return view('Admin.AssignSiteToCustomer.assign_site_to_customer', compact('device','customers','sites'));
         } 
